...
class TestDiffCommand(AuroraClientCommandTest):
  ...
  def test_success_no_diffs_metadata(self):
    ...
    one = [{"name": "serv", "metadata": [Metadata(key="a", value="1"),
        Metadata(key="b", value="2"), Metadata(key="ix0", value="2")]},
    ...
    two = [{"name": "serv", "metadata": [Metadata(key="b", value="2"),
        Metadata(key="a", value="1"), Metadata(key="ix0", value="2")]},
        {"name": "serv", "metadata": [Metadata(key="ix0", value="2"),
        Metadata(key="a", value="1"), Metadata(key="b", value="2")]},
        {"name": "serv", "metadata": [Metadata(key="a", value="1"),
        Metadata(key="ix0", value="2"), Metadata(key="b", value="2")]}]
  ...
  def test_success_diffs_metadata(self):
    ...
    assert MOCK_OUT == ['Task diffs found in instance 1',
      ("\tField 'metadata' is "
       "'({u'key': u'a', u'value': u'3'}, {u'key': u'b', u'value': u'2'},"
       " {u'key': u'ix0', u'value': u'2'})' local, but "
       "'({u'key': u'a', u'value': u'1'}, {u'key': u'b', u'value': u'2'}, "
       "{u'key': u'ix0', u'value': u'2'})' remote"),
