...
public class TaskGroups implements EventSubscriber {
   ...
   * <p>
   * This is used to observe {@link com.twitter.mesos.gen.ScheduleStatus#PENDING} tasks and begin
   ...
   * <p>
   * Upon this signal, all {@link com.twitter.mesos.gen.ScheduleStatus#PENDING} tasks in the stoage
  ...
  static class GroupKey {
    final TwitterTaskInfo scrubbedCanonicalTask;
