...
from twitter.aurora.executor.sandbox_manager import AppAppSandbox, DirectorySandbox
...
def build_local_runner():
  ...
  rc = subprocess.call(['./pants', 'src/python/twitter/aurora/executor:thermos_runner'])
