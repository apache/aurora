...
public class ServerSetModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(new TypeLiteral<Supplier<ServerSet.EndpointStatus>>() { }).to(EndpointSupplier.class);
  ...
  static class EndpointSupplier implements Supplier<ServerSet.EndpointStatus> {
    private final AtomicReference<ServerSet.EndpointStatus> reference = Atomics.newReference();
  ...
  private static class ServerSetJoiner implements Command {
    ...
    @Override public void execute() {
      ...
      shutdownRegistry.addAction(new ExceptionalCommand<ServerSet.UpdateException>() {
