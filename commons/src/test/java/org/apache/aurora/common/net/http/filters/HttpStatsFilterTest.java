...
public class HttpStatsFilterTest extends EasyMockTest {
  ...
  private void expectAnnotationValue(String value, int times) {
    ...
    HttpStatsFilter.TrackRequestStats annotation = createMock(HttpStatsFilter.TrackRequestStats.class);
    expect(matchedMethod.getAnnotation(HttpStatsFilter.TrackRequestStats.class)).andReturn(annotation).times(times);
