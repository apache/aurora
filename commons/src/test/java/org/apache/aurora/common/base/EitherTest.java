...
public class EitherTest {
  ...
  @Test
  public void testMap() {
    Either.Transformer<Object, CharSequence, Integer> transformer = Either.transformer(HASHCODE, LENGTH);
  ...
  public void testTransformer() {
    assertEquals(ImmutableList.of("jackjack", "4", "jilljill"),
        ImmutableList.copyOf(Iterables.transform(MIXED_RESULTS,
            new Either.Transformer<String, String, String>() {
  ...
  public void testGuard() {
    ...
    } catch (Either.UnguardedException e) {
