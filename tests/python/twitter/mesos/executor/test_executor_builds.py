...
def test_thermos_executor_build():
  build_and_execute_pex_target('src/python/twitter/mesos/executor:thermos_executor',
                               'dist/thermos_executor.pex')

def test_gc_executor_build():
  build_and_execute_pex_target('src/python/twitter/mesos/executor:gc_executor',
